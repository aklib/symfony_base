...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Products', 'fas fa-list', Product::class)->setPermission('ROLE_ADMIN');
        ...
        yield MenuItem::linkToCrud('User Profile', 'fas fa-list-ul', UserProfile::class)->setPermission('ROLE_USER');
    }
