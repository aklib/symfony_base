...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('ProductCategory', 'fas fa-stream', ProductCategory::class)->setPermission('ROLE_ADMIN')->setCssClass('ms-3');
        yield MenuItem::linkToCrud('ProductAttribute', 'fas fa-list-ol', ProductAttribute::class)->setPermission('ROLE_ADMIN')->setCssClass('ms-3');
        yield MenuItem::linkToCrud('ProductAttributeTab', 'fas fa-list-ol', ProductAttributeTab::class)->setPermission('ROLE_ADMIN')->setCssClass('ms-3');
